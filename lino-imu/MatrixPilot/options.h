...
#define ROLL_STABILIZATION_AILERONS			0 // 1
#define ROLL_STABILIZATION_RUDDER			0
#define PITCH_STABILIZATION				0 // 1
#define YAW_STABILIZATION_RUDDER			0 // 1
#define YAW_STABILIZATION_AILERON			0 // 1

// Aileron and Rudder Navigation
// Set either of these to 0 to disable use of that control surface for navigation.
#define AILERON_NAVIGATION				0 // 1
#define RUDDER_NAVIGATION				0 // 1
...
#define ALTITUDEHOLD_WAYPOINT			AH_NONE //	AH_FULL
...
#define NUM_INPUTS                                      1 // 5

// Channel numbers for each input.
// Use as is, or edit to match your setup.
//   - If you're set up to use Rudder Navigation (like MatrixNav), then you may want to swap
//     the aileron and rudder channels so that rudder is CHANNEL_1, and aileron is 5.
#define THROTTLE_INPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_3
#define AILERON_INPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_1
#define ELEVATOR_INPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_2
#define RUDDER_INPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_5
#define MODE_SWITCH_INPUT_CHANNEL		CHANNEL_UNUSED // CHANNEL_4
...
// 
#define THROTTLE_OUTPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_3
#define AILERON_OUTPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_1
#define ELEVATOR_OUTPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_2
#define RUDDER_OUTPUT_CHANNEL			CHANNEL_UNUSED // CHANNEL_4
...
#define SERIAL_OUTPUT_FORMAT     SERIAL_DEBUG // SERIAL_MAGNETOMETER //
